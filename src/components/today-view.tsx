...
const categoryStyles: Record<string, { bg: string; border: string; text: string; dot: string }> = {
  ...
  exercise:      { bg: "bg-rose-500/10",  border: "border-rose-500/30",  text: "text-rose-300",  dot: "bg-rose-400" },
  errands:       { bg: "bg-orange-500/10", border: "border-orange-500/30", text: "text-orange-300", dot: "bg-orange-400" },
  partner_time:  { bg: "bg-red-500/10",   border: "border-red-500/30",   text: "text-red-300",   dot: "bg-red-400" },
  meal_prep:     { bg: "bg-lime-500/10",  border: "border-lime-500/30",  text: "text-lime-300",  dot: "bg-lime-400" },
  cleaning:      { bg: "bg-teal-500/10",  border: "border-teal-500/30",  text: "text-teal-300",  dot: "bg-teal-400" },
